...
def build_project(debug: bool, clean: bool):
    ...
    extension_dirs = (
        # "archives/casc/",  # Optional: CASC support
        "archives/mpq/native/",  # Needed for MPQ support
        # "blp/BLP2PNG/",  # Optional: BLP to PNG conversion
        # "blp/PNG2BLP/"  # Optional: PNG to BLP conversion
    )
