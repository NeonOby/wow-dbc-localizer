...
class DBCFile:
    ...
    def write(self, f):
        ...
        # Pre-write all record data as zeros to allocate space
        # This ensures EOF will be at str_block_ofs
        current_pos = f.tell()
        f.write(b'\x00' * (self.header.record_count * self.header.record_size))
        
        # Now seek back and write actual record data
        f.seek(20)
        ...
        # Now EOF should be at str_block_ofs and we can write strings
        f.seek(0, 2)
